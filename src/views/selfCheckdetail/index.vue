    ...
    <div class="content">
      ...
      <div class="selfcheckList" style="margin-bottom:0.3rem">
        ...
        <div class="iteamsa">
          ...
          <div @click="getMap()">
            <p
              style="margin-left:0.2rem;margin-top:0.1rem;color:#333333;text-decoration:underline"
            >{{iteamList.handleSecAddr}}</p>
            <p
              style="margin-left:0.2rem;margin-top:0.1rem;color:#aeaeae;text-decoration:underline"
            >{{iteamList.handleAddr}}</p>
          </div>
        </div>
      </div>
      <p style="background: #fff;padding:0.2rem 0.3rem;">处理人：{{iteamList.handleUserName}}</p>
      <p
        style="background: #fff;padding:0.2rem 0.3rem;border-bottom:1px solid #f2f2f2"
      ...
      <div class="selfcheckList" style="margin-bottom:0.3rem;" v-if="iteamList.qualified!==3">
        <p style="background: #fff;padding:0.2rem 0.3rem;border-bottom:1px solid #f2f2f2">反馈信息</p>
        <p style="background: #fff;padding:0.1rem 0.3rem;">
          <span style="color:#666666">反馈时间：</span>
          {{iteamList.updateTime==undefined?'':FormatDate(iteamList.updateTime)}}
        </p>
        <p style="background: #fff;padding:0.1rem 0.3rem;">
          <span style="color:#666666">反馈人员：</span>
          {{iteamList.qualifieUserName}}
        </p>
        <p style="background: #fff;padding:0.1rem 0.3rem;">
          <span style="color:#666666">反馈情况：</span>
          {{iteamList.qualified==0?'不合格':iteamList.qualified==2?'合格':''}}
        </p>
        <p
          v-if="iteamList.qualified==0"
          style="background: #fff;padding:0.1rem 0.3rem;padding-bottom:0.2rem;border-bottom:1px solid #f2f2f2;"
        >
          <span style="color:#666666">不合格原因：</span>
          {{iteamList.unqualifiedReason}}
        </p>
      </div>
      ...
      <div
        v-if="iteamList.status!== 1&iteamList.qualified== 3&(roleCode=='global'||roleCode=='dispatch')"
        ...
        var markers = [
          {
            ...
            position: [
              this.iteamList.gaodeLongitude,
              this.iteamList.gaodeLatitude
            ]
          },
          {
